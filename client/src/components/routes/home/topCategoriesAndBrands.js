...
const TopCategoriesAndBrands = () => {
    ...
    return (
        <>
            {renderCategoryAndBrandsList("#Shop By Type", homeAPIData.data.brands, queryType.brand)}
            {renderCategoryAndBrandsList("#Shop By Categories", homeAPIData.data.apparels, queryType.apparel)}
        </>
    )
};
